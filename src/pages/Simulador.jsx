...
function Simulador() {
  ...
  // Taxa é calculada automaticamente baseado no valor
  const interestRate = useMemo(() => getTaxaByValue(form.value), [form.value]);
  ...
  const calculations = useMemo(() => {
    ...
    return results;
  }, [form.value, interestRate, form.installments, form.startDate]);
  ...
  return (
    <div className="page active">
      <style>{`
        ...
        .sim-table tbody tr:nth-child(even) { background: rgba(255,255,255,0.03); }
        ...
        /* Estilos para colunas de valores discriminados */
        .sim-td-amount {
          color: #16a34a;
          font-weight: 600;
        ...
        <div className="sim-grid-layout" style={{ marginBottom: "24px" }}>
          ...
          >
            <div className="sim-section">
              ...
              <div className="sim-input-group">
                <label className="sim-input-label">Taxa de Juros (a.m.)</label>
                <div
                  className="sim-input-wrapper"
                  style={{
                ...
                >
                  Taxa calculada automaticamente conforme o valor
                </p>
              </div>
          ...
          >
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                Abaixo está o cronograma detalhado de pagamento com todos os
              ...
              <table className="sim-table">
                <thead>
                  <tr>
                    <th>Parc</th>
                    <th>Vencimento</th>
                    <th style={{ color: "#16a34a" }}>💰 Valor da Parcela</th>
                    <th style={{ color: "#dc2626" }}>📈 Juros</th>
                    <th style={{ color: "#2563eb" }}>📉 Amortização</th>
                    <th style={{ color: "#7c3aed" }}>💳 Saldo Devedor</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div
              style={{
                backgroundColor: "rgba(240, 200, 80, 0.05)",
            ...
            >
              ...
              >
                <div>
                  ...
                  <p style={{ margin: 0 }}>
                    Valor total que você deve pagar em cada mês (juros +
                    amortização)
                  </p>
                </div>
                <div>
                  ...
                  <p style={{ margin: 0 }}>
                    Custo financeiro cobrado pelo período
                  </p>
                </div>
                <div>
                  <div
                  ...
                  <p style={{ margin: 0 }}>
                    Redução do saldo devedor (parte do pagamento que reduz a
                    dívida)
                  </p>
                </div>
                <div>
                  ...
                  <p style={{ margin: 0 }}>
                    Quanto você ainda deve após o pagamento da parcela
                  </p>
                </div>
              </div>
            </div>
