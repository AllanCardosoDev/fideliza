...
import { getTaxaByValue, getTaxaPctByValue } from "../utils/interestRates";
...
function LoanForm({
  ...
  const [form, setForm] = useState(
    initial || {
      ...EMPTY_LOAN,
      start_date: new Date().toISOString().split("T")[0], // Data de hoje (data da requisição do empréstimo)
    },
  );
    ...
    <form className="modal-form" onSubmit={handleSubmit}>
      ...
      <div className="form-row-2">
        <div className="form-row">
          ...
          >
            {form.value && form.interest_rate
              ? `Baseado no valor: ${getTaxaPctByValue(parseFloat(String(form.value).replace(",", ".")))}`
              : "Taxa varia conforme o valor"}
          </p>
