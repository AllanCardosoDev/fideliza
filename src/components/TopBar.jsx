...
function TopBar() {
  ...
  const isNotifAccessible = (notif) => {
    ...
    const isAdminOnly =
      text.includes("[admin]") ||
      text.includes("revisão pendente") ||
      text.includes("aguardando análise");
              ...
              <div className="notif-list">
                {unreadList.length > 0 ? (
                  unreadList.map((notif) => (
                    ...
                    >
                      <div
                        className={`notif-dot ${notif.type || "blue"}`}
                      ></div>
                      <div className="notif-text">
                        <div className="tx-desc">
                          {(notif.message || notif.text).replace(
                            /\[ADMIN\] /gi,
                            "",
                          )}
                        </div>
